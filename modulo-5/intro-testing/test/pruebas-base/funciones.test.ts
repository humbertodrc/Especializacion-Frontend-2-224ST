...
describe("Pruebas en funciones.ts", () => {
  ...
  test('La funcion debe retonar un valor si se llama al menos una vez', () => { 
    ...
    // console.log(myFunction.mock.results.map((result) => result.value));
    ...
    expect(myFunction(group)).toEqual(esperado);
