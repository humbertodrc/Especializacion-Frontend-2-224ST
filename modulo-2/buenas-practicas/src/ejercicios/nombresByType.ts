...
export const arrayOfGrades: Number[] = [8.5, 6.6, 7.8, 9.9, 10, 5.5, 4.4, 3.3, 2.2, 1.1];
...
export function getNoteForStuden() {
	throw new Error("Function not implemented.");
}

// obtiene las materias de una url
export function getSubjectsUrl(url: string) {
	throw new Error("Function not implemented.");
}

// obtiene el área de un cuadrado basado en sus lados
export function getSquareArea(area: number) {
	throw new Error("Function not implemented.");
}
